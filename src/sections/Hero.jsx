            ...
            <div className="hero-container">
                {
                    isTablet ? (
                        <>
                            { isMobile && <img src="/images/hero-bg.png" className="absolute bottom-40 size-full object-cover" alt="mobile bg"/> }
                            <img src="/images/hero-img.png" className="absolute bottom-0 left-1/2 -translate-x-1/2 object-auto" alt="tablet bg" />
                        </>
                    ) : (
